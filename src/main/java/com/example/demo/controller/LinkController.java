...
public class LinkController {
    ...
    @GetMapping(value = "/redirect", params = "code")
    ...
    @GetMapping(value = "/message", params = {"key", "code"})
    public ResponseEntity<String> getMessageByKey(@RequestParam("key") String key,
                                                              @RequestParam("code") String code) {
        return ResponseEntity.ok(linkService.getMessage(code,key));
    }
}
